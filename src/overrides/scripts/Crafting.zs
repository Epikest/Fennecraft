...
#Removing torch launcher recipe
print("--- removing torch launcher recipe ---");
recipes.remove(<cyclicmagic:tool_torch_launcher>);
print("--- removed torch launcher recipe ---");

#Removing smelting/melting of rails
print("--- removing rails recipe ---");
furnace.remove(<minecraft:gold_nugget>, <minecraft:golden_rail>);
furnace.remove(<minecraft:iron_nugget>, <minecraft:rail>);
furnace.remove(<minecraft:iron_nugget>, <minecraft:activator_rail>);
furnace.remove(<minecraft:iron_nugget>, <minecraft:detector_rail>);
...
print("--- removed rails recipe ---");

#Removing redundant flint recipe
print("--- removing redundant flint recipe ---");
recipes.removeShapeless(<minecraft:flint> * 2, [<minecraft:gravel>, <minecraft:gravel>]);
print("--- removed redundant flint recipe ---");
